...
int main()
{
  ...
  //rgb sliders, first one doesn't actually update the value
  Entities.push_back(
    new Slider(300,100,0,255,r)
  );
  Entities.push_back(
    new Slider(400,100,0,255,g,[&](int){bgColor = sf::Color(r,g,b);})
  );
  Entities.push_back(
    new Slider(500,100,0,255,b,[&](int){bgColor = sf::Color(r,g,b);})
  );
